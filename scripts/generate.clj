...
(defn body []
  [:body
   ...
   [:p "Lauri Oherd built the Ristinolla app as
        a Free app. This SERVICE is provided by
        Lauri Oherd at no cost and is intended for use as
        is."]
   ...
   [:p "The terms used in this Privacy Policy have the same meanings
        ...
        Ristinolla unless otherwise defined in this Privacy Policy."]
   [:p
   ...
   [:div
    ...
    [:ul [:li [:a {:href "https://www.google.com/policies/privacy/" :target "_blank"} "Google Play Services"]]]]
   [:p [:strong "Log Data"]]
   ...
   [:p [:strong "Changes to This Privacy Policy"]]
   [:p "I may update our Privacy Policy from
        time to time. Thus, you are advised to review this page
        periodically for any changes. I will
        notify you of any changes by posting the new Privacy Policy on
        this page."]
   [:p "This policy is effective as of 2020-05-28"]
   [:p [:strong "Contact Us"]]
   [:p "If you have any questions or suggestions about my
        Privacy Policy, do not hesitate to contact me at lauri.oherd@gmail.com."]
...
(let [index-edn  (html)
  ...
  (spit "privacy-policy.html" index-html))
